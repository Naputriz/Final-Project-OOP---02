...
import com.badlogic.gdx.utils.viewport.FitViewport; // [PENTING]
...
public class GameOverScreen extends ScreenAdapter {
    ...
    public void show() {
        ...
        // --- [PENTING] LOGIKA SIMPAN SKOR ---
        if (game.getPlayerName().equals("Guest")) {
            // 1. JIKA TAMU -> SIMPAN LOKAL (RAM)
            ...
            // 2. JIKA MEMBER -> KIRIM KE SERVER DATABASE
