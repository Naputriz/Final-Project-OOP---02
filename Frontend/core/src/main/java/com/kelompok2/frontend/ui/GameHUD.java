...
import com.kelompok2.frontend.Main; // [BARU]
...
public class GameHUD {
    ...
    // ... Variable Font & Constants sama persis ...
    private BitmapFont font;
    private BitmapFont fontSmall;
    private BitmapFont fontTitle;
    private BitmapFont fontBoss;
    ...
    private static final float BAR_Y = SCREEN_H - MARGIN - 35;
    ...
    private static final float SLOT_Y = MARGIN;
    private static final float STATS_X = MARGIN;
    private static final float STATS_Y = MARGIN + 140;
    private static final float TIMER_Y = SCREEN_H - MARGIN - 10;
    ...
    // [UBAH CONSTRUCTOR] Tambahkan Main game
    public GameHUD(Main game, SpriteBatch batch) {
        ...
        this.fontTimer.getData().setScale(2.5f);
    ...
    // Helper drawProgressBar, drawSkillSlot, drawCenteredText sama seperti sebelumnya...
